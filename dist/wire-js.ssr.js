...
var script = {
  ...
  mounted: function mounted() {
    ...
    this.loadingInterval = setInterval(function () {
      if (_this.loadingWidth < 80) {
        _this.loadingWidth += 10;
      }
    }, 200);
  },
  props: ["loading"]
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-5d3e75a1_0", {
    source: ".ternobo-loading[data-v-5d3e75a1]{display:flex;height:100vh;width:100vw;justify-content:center;align-items:center}.loading-container[data-v-5d3e75a1]{display:flex;flex-direction:column;justify-content:center;align-items:center}.spinner[data-v-5d3e75a1]{width:212px;height:5px;direction:ltr;background:#fff;margin-top:40px;box-shadow:0 6px 20px rgba(0,0,0,.2)}.spinner .spinner-icon[data-v-5d3e75a1]{background:#191919;height:100%;transition:.7s all;border-radius:5px;width:0}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-5d3e75a1";
/* module identifier */

var __vue_module_identifier__ = "data-v-5d3e75a1";
/* functional template */
