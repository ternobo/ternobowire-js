...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-6b078a9a_0", {
    ...
    map: undefined,
    media: undefined
  }), inject("data-v-6b078a9a_1", {
    source: ".ternobo-loading[data-v-6b078a9a]{display:flex;height:100vh;width:100vw;justify-content:center;align-items:center}.loading-container[data-v-6b078a9a]{display:flex;flex-direction:column;justify-content:center;align-items:center}.spinner[data-v-6b078a9a]{width:212px;height:5px;direction:ltr;background:#fff;margin-top:40px;box-shadow:0 6px 20px rgba(0,0,0,.2);overflow:hidden}.spinner .spinner-icon[data-v-6b078a9a]{background:#191919;height:100%;transition:.7s all;border-radius:5px;width:80px;animation-name:spinner-indicating;animation-duration:2s;animation-timing-function:cubic-bezier(0,0,.2,1);animation-iteration-count:infinite}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-6b078a9a";
/* module identifier */

var __vue_module_identifier__ = "data-v-6b078a9a";
/* functional template */
